...
$user=App\Models\User::where('role','=','user')->where('id',$session_id)->get();
...
<header class="header header-2 header-intro-clearance">
            ...
            <div class="header-middle">
                <div class="container">
                    ...
                    <div class="header-right">
                        <div class="account">
                            <a href="{{route('user.account')}}" title="My account">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <div class="product">
                                        <div class="product-cart-details">
                                            ...
                                            <span class="cart-product-info">
                                                ...
                                                x{{$cart->quantity*$cart->price}}
                                            </span>
                                        </div><!-- End .product-cart-details -->

                                        <figure class="product-image-container">
                                            <a href="product.html" class="product-image">
                                                <img src="{{!empty($cart->image)? url('upload/product_image/'.$cart->image):url('upload/no_image.jpg')}}" alt="product">
                                            </a>
                                        </figure>
                                        <a href="{{route('delete.cart.product',$cart->id)}}" class="btn-remove" title="Remove Product"><i class="icon-close"></i></a>
                                    </div><!-- End .product -->
                               ...
                               $temp_user=session()->get('temp_user');
                                   ...
                                   @endphp
                                    ...
                                    <span class="cart-total-price">{{$total}} Rs</span>
                                </div><!-- End .dropdown-cart-total -->

                                <div class="dropdown-cart-action">
                                    <a href="{{route('cart.page')}}" class="btn btn-primary">View Cart</a>
                                    <a href="{{route('checkout.page')}}" class="btn btn-outline-primary-2"><span>Checkout</span><i class="icon-long-arrow-right"></i></a>
                                </div><!-- End .dropdown-cart-total -->
                            ...
                            <div class="dropdown-menu">
                                <nav class="side-nav">
                                    <ul class="menu-vertical sf-arrows">
                                        ...
                                        <li class="item-lead"><a href="#">{{$catgory->name}}</a></li>
                                        @endforeach
                    ...
                    <div class="header-center">
                        <nav class="main-nav">
                            <ul class="menu sf-arrows">
                                ...
                                <li>
                                    <a href="#" class="sf-with-ul">Orders</a>

                                    <ul>
                                       
                                       
                                        <li><a href="{{route('frontend.all.orders')}}">All orders</a></li>
