				 ...
				 <div class="card">
					<div class="row g-0">
					  <div class="col-md-4 border-end">
						<img src="{{!empty($product->image)? url('upload/product_image/'.$product->image):url('upload/no_image.jpg')}}" class="img-fluid" alt="...">
						<div class="row mb-3 row-cols-auto g-2 justify-content-center mt-3">
							<div class="col"><img src="{{!empty($product->image)? url('upload/product_image/'.$product->image):url('upload/no_image.jpg')}}" width="70" class="border rounded cursor-pointer" alt=""></div>
